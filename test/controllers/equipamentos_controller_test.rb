...
class EquipamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipamento" do
    assert_difference('Equipamento.count') do
      post equipamentos_url, params: { equipamento: { arco: @equipamento.arco, cluster: @equipamento.cluster, descricao: @equipamento.descricao, designacao: @equipamento.designacao, enderecamento: @equipamento.enderecamento, estacao_id: @equipamento.estacao_id, firmware: @equipamento.firmware, status: @equipamento.status, tipo: @equipamento.tipo } }
    end
  ...
  test "should update equipamento" do
    patch equipamento_url(@equipamento), params: { equipamento: { arco: @equipamento.arco, cluster: @equipamento.cluster, descricao: @equipamento.descricao, designacao: @equipamento.designacao, enderecamento: @equipamento.enderecamento, estacao_id: @equipamento.estacao_id, firmware: @equipamento.firmware, status: @equipamento.status, tipo: @equipamento.tipo } }
