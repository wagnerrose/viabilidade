class Backoffice::Tabelas::EmpresasController < ApplicationController
  ...
  private
    ...
    def empresa_params
      params.require(:empresa).permit(:razao,:nome_fantasia, :cnpj, :sap, :endereco, :cidade,
                      :cep, :uf, :nome_contato, :fixo, :celular, :email)
    end
end
